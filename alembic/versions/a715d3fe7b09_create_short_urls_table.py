...
Revision ID: a715d3fe7b09
Revises: 
Create Date: 2026-08-04 15:27:11.856225
...
def upgrade() -> None:
    ...
    sa.Column('id_short_url', sa.Integer(), sa.Identity(always=False, start=1000), autoincrement=True, nullable=False),
